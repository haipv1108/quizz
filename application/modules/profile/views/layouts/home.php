              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url()."profile/profile/index";?>" class="btn btn-success btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url()."verify/logout";?>" class="btn btn-warning btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<?php if(isset($user)){?>
				<li class="treeview">
					<a href="<?php echo base_url()."profile/profile/edit/".$user['id'];?>">
			...
			<?php if($user['level'] == 1){?>
				<li class="treeview">
					<a href="<?php echo base_url()."profile/profile/review_test";?>".$user['id'];?>">
			...
			<?php }else if($user['level'] == 2){?>
				...
				<li class="treeview">
					<a href="<?php echo base_url()."profile/profile/choose_test";?>">
