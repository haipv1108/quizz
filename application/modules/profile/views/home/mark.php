						...
						<div class="box-header with-border">
						  <h3 class="box-title text-center">
							...
							<?php if(isset($user) && $user['level'] == 2){?>
									<a class="btn btn-block btn-success btn-lg text-center" href="test/printTest/<?php if(isset($test_info['id']) && !empty($test_info[id])) echo $test_info['id'];?>">Print this test</a>
							<?php }?>
						</div>
						<div class="box-body">
