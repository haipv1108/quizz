       <section class="content">
          <div class="row">
                ...
                <div class="box box-success">
                  <div class="box-header with-border">
                    ...
                    <p class="text-center" style="color:red">Huong dan lam bai</p>
          					<form>
          						<a class="btn btn-primary" href="test/printTest/<?php if(isset($testid) && !empty($testid)) echo $testid;?>">Print this test</a>
          					</form>
                  </div>
                  <div class="box-body">
            ...
            <div id="thong_ke" class="col-md-3">
              <div id="time" class="fixed">
                <div class="bg-yellow fixed">
                  <div class="description-block padding-bottom" >
